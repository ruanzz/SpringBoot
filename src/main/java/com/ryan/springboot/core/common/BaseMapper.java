...
/**
 * 通用Mapper接口，所有Mapper都要实现这个接口
 *
 * @author ruanzz
 * @create 2018-07-15 4:04 PM
 * <p>
 * 通用Mapper常用方法:
 * <p>
 * 等号的CRUD:
 ...
 **/
public interface BaseMapper<T extends BaseModel> extends tk.mybatis.mapper.common.BaseMapper<T>, ConditionMapper<T>, IdsMapper<T>, InsertListMapper<T> {
    /**
     * 根据uuid删除数据
     *
     * @return
